...
$sql="SELECT MAX(id_venta) AS id FROM tb_ventas";
$execute= $conectar->query($sql);
if ($row = mysqli_fetch_row($execute)) {
  $id_last = trim($row[0]);
}
$sql="SELECT * FROM tb_ventas WHERE id_venta='$id_last'";
$execute= $conectar->query($sql);
      ...
      <table data-toggle="table"   data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
        <thead>
          <tr>
            ...
            <th data-sortable="true">Costo de horno</th>
...
<div class="col-lg-12">
  ...
  <a class="btn btn-info" onclick="finalizar_venta(<?php echo $clave_venta; ?>)">FINALIZAR VENTA</a>
  <br>
  <br>
</div>
